...
namespace Modules\Affiliation\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Support\Facades\Route;

/**
 * AffiliationServiceProvider
 *
 * Fournisseur de services principal du module Affiliation.
 * Enregistre les services, charge les configurations et les routes.
 *
 * @package Modules\Affiliation\Providers
 */
class AffiliationServiceProvider extends ServiceProvider
{
    /**
     * Nom du module
     *
     * @var string
     */
    protected string $moduleName = 'Affiliation';
     ...
     * @var string
     */
    protected string $moduleNameLower = 'affiliation';
    ...
    public function boot(): void
    {
        $this->registerConfig();
        $this->registerRoutes();
        $this->loadMigrationsFrom($this->modulePath . '/src/Database/Migrations');
    }
    ...
    {
        // Enregistrement des services spécifiques au module Affiliation
    }
    ...
    {
        $routesPath = $this->modulePath . '/src/Routes';
